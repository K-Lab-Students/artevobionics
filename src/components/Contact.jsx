                ...
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center space-y-8 md:space-y-0">
                    <div className="w-full md:ml-16">
                        <p className="w-4/5  text-3xl font-normal font-primary text-white mb-4">
                            ХОТИТЕ ПОМОЧЬ ПРОЕКТУ ИЛИ ОКАЗАТЬ СОДЕЙСТВИЕ?
                        </p>
                        ...
                        <Link 
                            to="/contacts" 
                            className="bg-white hover:bg-hover text-black text-xl font-primary font-[600] w-auto py-2 px-4 rounded-4xl inline-block transition-colors duration-200 cursor-pointer"
                        >
                            КОНТАКТЫ
                        </Link>
                    </div>
